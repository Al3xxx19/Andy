...
This mechanism has been integrated into Bitcore-Node-ANDYcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ANDYcoin-Project/insight-api-ANDYcoin#web-socket-api](https://github.com/ANDYcoin-Project/insight-api-ANDYcoin#web-socket-api) 
* API: [https://github.com/ANDYcoin-Project/insight-api-ANDYcoin#swifttx-transactions](https://github.com/ANDYcoin-Project/insight-api-ANDYcoin#swifttx-transactions) 
...
By default, the ANDYcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ANDYcoin Core daemon:
