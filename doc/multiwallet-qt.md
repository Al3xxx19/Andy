...
In order to support loading of multiple wallets in ANDYcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ANDYcoin.cpp.
...
Changes to ANDYcoin.cpp
----------------------
ANDYcoin.cpp is the entry point into ANDYcoin-qt, and as such, will require some minor modifications to provide hooks for
