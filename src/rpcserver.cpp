...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop ANDYcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "ANDYcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ANDYcoin features */
        {"ANDYcoin", "masternode", &masternode, true, true, false},
        {"ANDYcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"ANDYcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ANDYcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ANDYcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ANDYcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"ANDYcoin", "startmasternode", &startmasternode, true, true, false},
        {"ANDYcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ANDYcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ANDYcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ANDYcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ANDYcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ANDYcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ANDYcoin", "mnbudget", &mnbudget, true, true, false},
        {"ANDYcoin", "preparebudget", &preparebudget, true, true, false},
        {"ANDYcoin", "submitbudget", &submitbudget, true, true, false},
        {"ANDYcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ANDYcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ANDYcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ANDYcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ANDYcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ANDYcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ANDYcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ANDYcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"ANDYcoin", "mnsync", &mnsync, true, true, false},
        {"ANDYcoin", "spork", &spork, true, true, false},
        {"ANDYcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ANDYcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ANDYcoind, or the -server option to ANDYcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ANDYcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:49401/\n";
}
