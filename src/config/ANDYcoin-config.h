/* src/config/ANDYcoin-config.h.  Generated from ANDYcoin-config.h.in by configure.  */
/* src/config/ANDYcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ANDY_CONFIG_H

#define ANDY_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.cardbuyers.skypool.fr"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ANDYcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ANDYcoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ANDYcoin"
