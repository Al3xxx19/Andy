...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ANDYcoin Core"),
     ...
     * override -datadir in the ANDYcoin.conf file in the default data directory
     * (to be consistent with ANDYcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
