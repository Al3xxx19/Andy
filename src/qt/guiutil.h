...
/** Utility functions used by the ANDYcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render ANDYcoin addresses in monospace font
...
// Parse "ANDYcoin:" URI into recipient object, return true on successful parsing
