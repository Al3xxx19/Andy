...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ANDYcoin Core ANDYcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ANDYcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ANDYcoin transaction") + "\n" +
                               "  ANDYcoin-tx [options] -create [commands]   " + _("Create hex-encoded ANDYcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ANDYcoin transaction
