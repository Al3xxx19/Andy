...
!define COMPANY "ANDYcoin Core project"
...
!else
InstallDir $PROGRAMFILES\ANDYcoin
!endif
CRCCheck on
XPStyle on
BrandingText " "
...
VIAddVersionKey ProductName "ANDYcoin Core"
...
Section -Main SEC0000
    ...
    # Remove old wxwidgets-based-ANDYcoin executable and locales:
    Delete /REBOOTOK $INSTDIR\ANDYcoin.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\ANDYcoin-qt.exe
    ...
    WriteRegStr HKCR "ANDYcoin" "URL Protocol" ""
    WriteRegStr HKCR "ANDYcoin" "" "URL:ANDYcoin"
    WriteRegStr HKCR "ANDYcoin\DefaultIcon" "" $INSTDIR\ANDYcoin-qt.exe
    WriteRegStr HKCR "ANDYcoin\shell\open\command" "" '"$INSTDIR\ANDYcoin-qt.exe" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\ANDYcoin-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMSTARTUP\ANDYcoin.lnk"
